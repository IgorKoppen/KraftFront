                ...
                <div className="flex flex-col items-center h-screen  pt-0 mx-auto justify-center lg:py-0">
                    <div className="w-full bg-MainColor rounded-lg  md:mt-0 sm:max-w-md xl:p-0 ">
                        <div className="  p-5">
                            ...
                            <h2 className="text-lg font-bold leading-tight tracking-tight text-white">Marca: {produto?.nome}</h2>
                            <p className="text-sm font-bold leading-tight tracking-tight text-white">Descrição: {produto?.descricao}</p>
