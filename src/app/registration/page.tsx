            ...
            <div className="h-screen md:flex">
                <div
                    ...
                    <div>
                        ...
                        <button type="submit" className="block w-28 bg-white text-indigo-800 mt-4 py-2 rounded-2xl font-bold mb-2">Voltar</button>
                    </div>
                ...
                <div className="flex md:w-1/2 justify-center py-10 items-center bg-white">
                    <form className="bg-white">
                        ...
                        <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                            ...
                            <input className="pl-2 outline-none border-none" type="text" name="" id="" placeholder="Confirmar senha" />
                        </div>
                        <button type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Registrar</button>
                        <span className="text-sm ml-2 hover:text-blue-500 cursor-pointer">Já possui uma conta ?</span>
                    </form>
                </div>
            </div>
        </>
